...
export default function BibleReadingPlanSection() {
  ...
  return (
    <section id="bible-plan" className="relative z-20">
      <BiblePlanModal isOpen={isPreviewOpen} onClose={() => setIsPreviewOpen(false)} />

      {/* ── Main content area ──────────────────── */}
      <div className="relative pt-24 pb-40 md:pb-52 bg-[var(--color-background)] overflow-hidden">
            ...
            <div className="max-w-2xl text-center lg:text-left">
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-[var(--color-text-secondary)] font-light leading-relaxed mb-16 max-w-xl mx-auto lg:mx-0">
                  Join our 53-week journey through the scriptures. Deepen your faith, understand
                  your purpose, and stay on fire for God throughout the year.
                </p>
      ...
      <div className="relative -mt-1">
        {/* Plum glow that bleeds across the boundary */}
        <div className="absolute left-1/2 -translate-x-1/2 -top-20 w-[600px] h-40 bg-plum/8 rounded-full blur-[80px] pointer-events-none" />
        ...
        >
          {/* Background fill — matches the Bible section */}
          <path
            d="M0 0H1440V40C1440 40 1200 120 720 120C240 120 0 40 0 40V0Z"
