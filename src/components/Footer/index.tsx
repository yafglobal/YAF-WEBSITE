...
export default function Footer() {
  return (
    <footer
      id="contact"
      className="relative overflow-hidden footer-light bg-[var(--color-background)]"
    >
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 py-20 md:py-28">
          ...
          <ScrollReveal delay={0.1}>
            <div className="mt-10 flex flex-col sm:flex-row items-start gap-4">
              <a
                href="#"
                className="group inline-flex items-center gap-3 px-6 py-3.5 md:px-8 md:py-4 bg-fire text-white font-display font-semibold text-xs md:text-sm tracking-wide uppercase rounded-full hover:bg-fire-light transition-all duration-300 hover:shadow-[var(--shadow-fire-sm)]"
              >
