      ...
      <ScrollReveal delay={0.2}>
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3 text-[var(--color-text-secondary)] text-sm">
            <MapPin size={16} className="text-plum mt-0.5 shrink-0" weight="fill" />
          ...
          <div className="flex items-center gap-3 text-[var(--color-text-secondary)] text-sm">
            <Phone size={16} className="text-plum shrink-0" weight="fill" />
            <span>+234 816 287 9125</span>
          </div>
          <div className="flex items-center gap-3 text-[var(--color-text-secondary)] text-sm">
            <EnvelopeSimple size={16} className="text-plum shrink-0" weight="fill" />
